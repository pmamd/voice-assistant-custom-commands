...
// ROCm 6.5+ (HIP 6.5+) renamed hipblasDatatype_t to hipblasComputeType_t / hipDataType.
// Use version-conditional mappings so the same code builds on both old and new ROCm.
